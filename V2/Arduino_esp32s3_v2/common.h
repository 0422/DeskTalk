...
#define APPID "8836454391"
#define TOKEN "aGrgzjVNRTJah3Xj6fdNkAru4Svuej4M"

// New Speech Console authentication. Leave empty when APPID/TOKEN are the
// legacy App ID and Access Token pair.
#ifndef VOLC_API_KEY
#define VOLC_API_KEY ""
#endif
